...
public class LoginGUI extends JFrame {
	...
	public LoginGUI() {
		...
		JLabel lbl_logo = new JLabel(new ImageIcon(LoginGUI.class.getResource("")));
		lbl_logo.setBounds(232, 11, 255,158);
		w_pane.add(lbl_logo);

		JLabel lblHastaneYnetimSistemine = new JLabel("Hastane Yonetim Sistemine Hoşgeldiniz");
		lblHastaneYnetimSistemine.setFont(new Font("Yu Gothic UI Semilight", Font.BOLD, 17));
		lblHastaneYnetimSistemine.setBounds(191, 11, 387, 22);
		w_pane.add(lblHastaneYnetimSistemine);

		JTabbedPane w_tabpane = new JTabbedPane(JTabbedPane.TOP);
		w_tabpane.setBounds(116, 240, 474, 195);
		w_pane.add(w_tabpane);

		JPanel w_doctorLogin = new JPanel();
		w_doctorLogin.setBackground(Color.ORANGE);
		...
		btn_doktorLogin.setForeground(Color.BLACK);
		btn_doktorLogin.setBackground(Color.RED);
		...
		w_doctorLogin.add(fld_doktorPass);
				...
				w_hastaLogin.setBackground(Color.ORANGE);
								...
								w_hastaLogin.add(lblSifre);
										...
										fld_hastaTc.setColumns(10);
												...
												w_hastaLogin.add(btn_register);
														...
														btn_hastaLogin.setBackground(Color.RED);
		...
		JLabel lblNewLabel = new JLabel(new ImageIcon(LoginGUI.class.getResource("23005-5-health-photos.png")));
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 9));
		lblNewLabel.setBounds(10, 11, 666, 442);
